...
def generate_features(
    ...
    cbfv_path = dirpath + "/data/element_properties/" + elem_prop + ".csv"

    if not os.path.exists(cbfv_path):
        cbfv_path = (
            dirpath + "/data/element_properties/bm_element_props/" + elem_prop + ".csv"
        )

    if not os.path.exists(cbfv_path):
        cbfv_path = (
            dirpath + "/data/element_properties/mb_element_props/" + elem_prop + ".csv"
        )
